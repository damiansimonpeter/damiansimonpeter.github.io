...
angular
  ...
  .controller('MainCtrl', function ($modal, $scope, moment) {
	...
	/*Service to return all events, that belongs to the logged in user 
      ...
      {
        title: 'Tayos wedding',
		description:'Be, there at my wedding pls.',
        address: '23, Akinfowoshe str',
        type: 'warning',
        ...
        title: 'Simon Peters Birthday',
        description:'Breaking the boundaries, the bills on me',
        address: '23, Akinfowoshe str',
        type: 'info',
